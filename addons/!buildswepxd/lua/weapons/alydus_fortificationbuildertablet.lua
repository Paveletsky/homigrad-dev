...
if CLIENT then
	...
	if GAMEMODE.IsSandboxDerived then
		language.Add("SBoxLimit_fortifications", "Лимит построек")
	end

	language.Add("Undone_Fortification", "Постройка удалена")

	language.Add("Cleanup_fortifications", "Удалить постройки")
	language.Add("Cleaned_fortifications", "Все постройки удалены")
elseif SERVER then
	CreateConVar("sbox_maxfortifications", 25)
end

cleanup.Register("fortifications")

SWEP.Author = "Homigrad"
SWEP.Instructions = "Киянка для постройки\n ЛКМ/ПКМ - выбор пропа \n E - поставить \n R - удалить"
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.Spawnable = true
...
SWEP.UseHands = false
SWEP.ViewModel = ""
SWEP.WorldModel = "models/rust_hammer.mdl"
SWEP.ShowViewModel = false 
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["ValveBiped.Grenade_body"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(275, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.Fortifications = {
{name = "Уголок мешков с песком 1", model = "models/props_fortifications/sandbags_corner1.mdl"},
{name = "Мешки с песком, угол 1, высота", model = "models/props_fortifications/sandbags_corner1_tall.mdl"},
{name = "Уголок мешков с песком 2", model = "models/props_fortifications/sandbags_corner2.mdl"},
{name = "Мешки с песком, угол 2, высота", model = "models/props_fortifications/sandbags_corner2_tall.mdl"},
{name = "Уголок мешков с песком 3", model = "models/props_fortifications/sandbags_corner3.mdl"},
{name = "Линия мешков с песком 1", model = "models/props_fortifications/sandbags_line1.mdl"},
{name = "Мешки с песком, линия 1, высота", model = "models/props_fortifications/sandbags_line1_tall.mdl"},
{name = "Линия мешков с песком 2", model = "models/props_fortifications/sandbags_line2.mdl"},
{name = "Мешки с песком, линия 2, высота", model = "models/props_fortifications/sandbags_line2_tall.mdl"},
{name = "Линия мешков с песком 3", model = "models/props_fortifications/sandbags_line2b.mdl"},
{name = "Бетонная стена", model = "models/props_fortifications/concrete_wall001_96_reference.mdl"},
{name = "Бетонный барьер 1", model = "models/props_c17/concrete_barrier001a.mdl"},
{name = "Бетонный барьер 2, маленький", model = "models/props_fortifications/concrete_barrier001_96_reference.mdl"},
{name = "Бетонный барьер 2, большой", model = "models/props_fortifications/concrete_barrier001_128_reference.mdl"},
{name = "Бетонный барьер 3", model = "models/jbarnes/props/concrete barricade.mdl"},
{name = "Маленький забор", model = "models/props_c17/fence01b.mdl"},
{name = "Средний забор", model = "models/props_c17/fence01a.mdl"},
{name = "Большой забор", model = "models/props_c17/fence03a.mdl"},
{name = "Маленький забор против перелезания", model = "models/props_wasteland/exterior_fence002b.mdl",},
{name = "Средний забор, препятствующий перелезанию", model = "models/props_wasteland/exterior_fence002c.mdl"},
{name = "Большой забор, препятствующий перелезанию", model = "models/props_wasteland/exterior_fence002d.mdl"},
{name = "Одиночная полицейская баррикада", model = "models/props_street/police_barricade.mdl"},
{name = "Тройная полицейская баррикада", model = "models/props_street/police_barricade2.mdl"},
{name = "Малый насып", model = "models/static_afghan/prop_fortification_hesco_small.mdl"},
{name = "Насып", model = "models/iraq/ir_hesco_basket_01.mdl"}
}
...
SWEP.WElements = {
	["tablet"] = { type = "Model", model = "models/rust_hammer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0.597), angle = Angle(226.882, 150.376,0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {} },
			...
			if IsValid(ply) and IsValid(ply:GetActiveWeapon()) and ply:GetActiveWeapon():GetClass() == "alydus_fortificationbuildertablet" and ply:GetActiveWeapon().Fortifications[ply:GetActiveWeapon():GetSelectedFortification()] then
				...
				elseif IsValid(playerFortificationHolograms[ply:SteamID64()]) then
					...
					if ply:CanDrawAlydusFortification() then
						fortificationHologram:SetColor(Color(255, 255, 255, 72))
					else
	...
	function SWEP:DrawHUD()
		...
		if IsValid(ply) and IsValid(ply:GetActiveWeapon()) and ply:GetActiveWeapon():GetClass() == "alydus_fortificationbuildertablet" then
			...
			if IsValid(playerFortificationHolograms[ply:SteamID64()]) and ply:CanDrawAlydusFortification() then
				...
				draw.DrawText("E - Поставить\nR - Удалить", "Alydus.FortificationsTablet.Subtitle", pos2d.x, pos2d.y + 52, Color(0, 0, 0), TEXT_ALIGN_CENTER)
				draw.DrawText("E - Поставить\nR - Удалить", "Alydus.FortificationsTablet.Subtitle", pos2d.x, pos2d.y + 50, Color(46, 167, 197), TEXT_ALIGN_CENTER)
			end
		end
	end
