hook.Add('Think', 'bkInitSkin', function()
	...
	function SKIN:PaintFrame(pnl, w, h)
		...
		-- cam.PopModelMatrix()
		draw.RoundedBox(5, 0, 0, w, h, Color(30, 60, 90, 255))
		draw.RoundedBoxEx(5, 0, 0, w, 3, Color(55, 115, 180, 220), true, true, true, true)
	end
	...
	function SKIN:PaintButton(pnl, w, h)
		...
		pnl:SetFontInternal( "player.name" )
	end
	...
	function SKIN:PaintNumSlider( panel, w, h )
		...
		draw.RoundedBox(10, 0, 15, w, h / 6, Color( 55, 115, 180, 200))
	...
	function SKIN:PaintCategoryButton( panel, w, h )
		...
		if ( panel.AltLine ) then
			...
			if ( panel.Depressed or panel.m_bSelected ) then draw.RoundedBox(4, 0, 0, w, h, Color(55, 115, 180, 255))
			elseif ( panel.Hovered ) then draw.RoundedBox(4, 0, 0, w, h, Color(55, 115, 180, 255))
			else draw.RoundedBox(4, 0, 0, w, h, Color(255,255,255, 1)) end
	
		else
	
			if ( panel.Depressed or panel.m_bSelected ) then draw.RoundedBox(1, 0, 0, w, h, Color(10, 79, 153))
			elseif ( panel.Hovered ) then draw.RoundedBox(4, 0, 0, w, h, Color(55, 115, 180, 255))
			end
	...
	function SKIN:PaintWindowCloseButton(pnl, w, h)
		...
		local wave = Material( "icons16/cross.png", "noclamp smooth" )
		...
		if pnl.Depressed then
			if pnl.Hovered then
				...
				surface.SetDrawColor( 175, 68, 68)
	...
	function SKIN:PaintPropertySheet(pnl, w, h)
		...
		draw.RoundedBoxEx(2, 0, 2, w, 30, Color(0, 0, 0, 190), true, true, false, false)
	...
	function SKIN:PaintScrollBarGrip( panel, w, h )
		...
		draw.RoundedBox(0, w/2-4, 0, 8, h - 10, Color( 94, 135, 240))
		draw.RoundedBox(0, w / 2-4, 5, 50, h - 10, Color( 96, 94, 240, 100))
	
		if ( panel:GetDisabled() ) then
			return draw.RoundedBox(15, w/2-4, 0, 8, h, Color( 55, 115, 180 ))
		end
	...
	function SKIN:PaintMenuSpacer( pnl, w, h )
		...
		surface.SetDrawColor(Color(55, 115, 180, 255))
		surface.DrawRect(0, 0, w, h)
	...
	function SKIN:PaintCollapsibleCategory(pnl, w, h)
		...
		draw.RoundedBox(4, 0, 5, w, h, Color(25, 45, 70, 250))
		draw.RoundedBox(4, 0, 0, w, 20, Color(55, 115, 180))
	...
	function SKIN:PaintMenuBar( pnl, w, h )
		...
		draw.RoundedBox(0, 0, 0, w, h, Color(55, 115, 180, 255))
		...
		if pnl.m_bBackground then
			if pnl.PaintOffset then
				...
				elseif pnl:HasFocus() then
					...
					draw.RoundedBox(5, 0, 0, w, h, Color(15, 35, 55, 155))
				end
			end
		end
