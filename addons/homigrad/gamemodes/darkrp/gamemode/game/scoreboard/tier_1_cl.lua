...
local function ToggleScoreboard(toggle)
	if toggle then
		...
		HomigradScoreboard.Paint = function(self,w,h)
			...
			draw.SimpleText("Ранг","HomigradFont", 400 ,15,white,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
		...
		function HomigradScoreboard:AddPlayer(ply)
			...
			playerPanel.Paint = function(self,w,h)
				...
				draw.SimpleText(ply:GetUserGroup(),"HomigradFont",400,h / 2, Color(255, 255, 255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
