...
hook.Add("HUDPaint","homigrad-roundstate",function()
	if roundActive then
		...
		draw.WordBox(5, ScrW() / 2, ScrH() - 50, #PlayersInGame() < 1 and "Нужно минимум 2 игрока" or " Раунд закончен ", 'fdShopFontBig', Color(35, 35, 35, 200), color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
