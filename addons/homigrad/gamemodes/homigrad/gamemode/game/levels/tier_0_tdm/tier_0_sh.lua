...
tdm.red = {
	...
	weapons = {"weapon_binokle","weapon_radio","weapon_t","weapon_hands","med_band_big","med_band_small","medkit","painkiller"},
...
function tdm.GetTeamName(ply)
	...
	if team then
		...
		return team[1] or 'Неизвестно', team[2] or color_white
	end
end
