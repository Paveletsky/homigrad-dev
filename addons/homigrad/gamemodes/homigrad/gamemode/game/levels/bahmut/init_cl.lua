...
function bahmut.HUDPaint_RoundLeft(white)
    ...
    if startRound > 0 and lply:Alive() then
        ...
        draw.DrawText( "Специальная Военная Операция", "fdShopFontBig", ScrW() / 2, ScrH() - 105, Color( 155,155,55,math.Clamp(startRound - 0.5,0,1) * 255 ), TEXT_ALIGN_CENTER )
        ...
        draw.DrawText( "Нейтрализуйте вражескую команду, соблюдайте военные правила, спасайте своих...", "fdShopFontBig", ScrW() / 2, ScrH() - 75, Color( 55,55,55,math.Clamp(startRound - 0.5,0,1) * 255 ), TEXT_ALIGN_CENTER )
        return
    end
end