...
function dm.HUDPaint_RoundLeft(white)
    ...
    if startRound > 0 and lply:Alive() then
        ...
        draw.DrawText( "БОЕЦ САМ ПО СЕБЕ СТРЕЛЕЦ", "fdShopFontBig", ScrW() / 2, ScrH() / 2, Color( 155,155,255,math.Clamp(startRound - 0.5,0,1) * 255 ), TEXT_ALIGN_CENTER )
        ...
        draw.DrawText( "Убивай всех на своем пути!", "fdShopFontBig", ScrW() / 2, ScrH() - 75, Color( 255,255,255,math.Clamp(startRound - 0.5,0,1) * 255 ), TEXT_ALIGN_CENTER )
        return
    end
end
