...
SWEP.PrintName 				= "Установка Пулемёта"
SWEP.Author 				= "Homigrad"
SWEP.Instructions			= "Установить Пулемёт"
...
local list = {}
list.gred_emp_mg34 = Vector(0,0,46)
list.gred_emp_mg42 = Vector(0,0,45)
list.gred_emp_mg81z = Vector(0,0,45)
...
if SERVER then
    ...
    hook.Add("Gred Emplacment Use","Mimomet",function(ent,ply)
        ...
        if ply:HasWeapon("weapon_gredpulemot") then return true end

        ply:Give("weapon_gredpulemot"):SetNWString("Gred",ent:GetClass())
