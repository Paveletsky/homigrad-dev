...
Vectors = {
	...
	["weapon_hk_arbalet"] = Vector(5, 7, 2),
...
Vectors2 = {
	...
	["weapon_hk_arbalet"] = Vector(12, 20, -12),
...
function SpawnWeapon(ply, clip1)
	...
	if not IsValid(ply.wep) and table.HasValue(Guns, ply.curweapon) then
...
function FireShot(wep)
	...
	bullet.Attacker = ply
	bullet.Callback = function(ply, tr) wep:BulletCallbackFunc(damage, ply, tr, damage, false, true, false) end
	--[[local bullet = {}
		bullet.Num 			= 1
		bullet.Src 			= shootOrigin
		bullet.Dir 			= shootDir
