...
if SERVER then
	util.AddNetworkString("day_of_coding")
	COMMANDS = COMMANDS or {}
	COMMANDS.dayofcoding = {function(ply,args)
		net.Start("day_of_coding")
		net.WriteBool(true)
	...
	net.Receive("day_of_coding",function()
		...
		if net.ReadBool() then
			...
			hook.Add("HUDPaint","day_of_coding",function()
				dayofcodingHUD()
			end)
		else
			hook.Remove("HUDPaint","day_of_coding")
