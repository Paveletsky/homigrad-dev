...
concommand.Add("+leanleft", function(ply, cmd, args) SIX.Binds.left = true end)
concommand.Add("-leanleft", function(ply, cmd, args) SIX.Binds.left = false end)
concommand.Add("+leanright", function(ply, cmd, args) SIX.Binds.right = true end)
concommand.Add("-leanright", function(ply, cmd, args) SIX.Binds.right = false end)