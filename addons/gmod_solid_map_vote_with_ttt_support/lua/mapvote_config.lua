...
local linkr = {
    "https://imgur.com/2ged5aB.png",
    "https://imgur.com/3hI0yek.png",
    "https://imgur.com/eQWNkaJ.png"
}
SolidMapVote[ 'Config' ][ 'Missing Image' ] = linkr[math.random(1, #linkr)]
SolidMapVote[ 'Config' ][ 'Missing Image Size' ] = { width = 512, height = 512 }
